            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Get instant, AI-powered insights into your Shopify store's unique character. 
                  From vibe descriptions to target customers, discover what makes your brand special.
                </p>
              </div>
